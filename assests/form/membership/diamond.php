  ...
  if($_SERVER["REQUEST_METHOD"] == "POST"){
    if(isset($_POST['submit'])){       
        ...
        $result = mysqli_query($conn , $query);      
          ...
          echo
          "<script> alert('You have To Login SignUp First'); 
          window.location.href = './gold.php';
...
<body id="contact-us" class="">
    <div class="container card-contact g-3">
        ...
        <div class="forgot text-start">
            <a href="../../../index.php" class="text-white " style="font-size: 18px;">Back to Home Page</a>
        </div>
        <form method="post" id="frm" action="#" class="row justify-content-center ">
            <div class="col-lg-8 p-3">
                ...
                <h4 class="text-white text-center mb-4">Membership Type : <span
                        style="color: gold; font-weight: 600;">DIAMOND</span></h4>
                <div class="row g-3">
                    ...
                    <div class="form-group col-md-4 mt-3">
                        <input type="tel" class="form-control" name="email" placeholder="Mobile No"
                    ...
                    <div class="form-group col-md-12 col-lg-6">
                        <input class="form-control" id="disabledInput"  type="text"
                            name="pretime" placeholder="Preffered Time For Gym ">
                    </div>
